...
/**
 * Exception thrown if a mapped object could not be retrieved via its identifier. Provides information about the persistent class and the
 * identifier.
 *
...
public class ObjectRetrievalFailureException extends DataRetrievalFailureException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5887798707010752280L;
