...
package com.dev.ck.ackwd.config.springframework.orm;

import org.springframework.dao.OptimisticLockingFailureException;

/**
 * Exception thrown on an optimistic locking violation for a mapped object. Provides information about the persistent class and the
 * identifier.
 *
...
public class ObjectOptimisticLockingFailureException extends OptimisticLockingFailureException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -864764099234738948L;
	...
	public ObjectOptimisticLockingFailureException(Class persistentClass, Object identifier, Throwable cause) {
		...
		this(persistentClass, identifier, "Object of class [" + persistentClass.getName() + "] with identifier [" + identifier
	...
	public ObjectOptimisticLockingFailureException(String persistentClassName, Object identifier, Throwable cause) {
		...
		this(persistentClassName, identifier, "Object of class [" + persistentClassName + "] with identifier [" + identifier
				+ "]: optimistic locking failed", cause);
	}
	...
	/**
	 * Return the name of the persistent class of the object for which the locking failed. Will work for both Class objects and String
	 * names.
	 */
