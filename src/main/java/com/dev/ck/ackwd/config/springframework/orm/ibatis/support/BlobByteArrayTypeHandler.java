...
/**
 * iBATIS TypeHandler implementation for byte arrays that get mapped to BLOBs. Retrieves the LobHandler to use from SqlMapClientFactoryBean
 * at config time.
 *
 * <p>
 * Can also be defined in generic iBATIS mappings, as DefaultLobCreator will work with most JDBC-compliant database drivers. In this case,
 * the field type does not have to be BLOB: For databases like MySQL and MS SQL Server, any large enough binary type will work.
 *
