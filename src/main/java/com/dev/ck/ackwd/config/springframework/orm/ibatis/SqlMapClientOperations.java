...
/**
 * Interface that specifies a basic set of iBATIS SqlMapClient operations, implemented by {@link SqlMapClientTemplate}. Not often used, but
 * a useful option to enhance testability, as it can easily be mocked or stubbed.
 *
 * <p>
 * Defines SqlMapClientTemplate's convenience methods that mirror the iBATIS {@link com.ibatis.sqlmap.client.SqlMapExecutor}'s execution
 * methods. Users are strongly encouraged to read the iBATIS javadocs for details on the semantics of those methods.
 *
...
public interface SqlMapClientOperations {
	...
	/**
	 * Convenience method provided by Spring: execute an update operation with an automatic check that the update affected the given
	...
	/**
	 * Convenience method provided by Spring: execute a delete operation with an automatic check that the delete affected the given required
	 * number of rows.
	 * 
	 * @param statementName
	 *            the name of the mapped statement
